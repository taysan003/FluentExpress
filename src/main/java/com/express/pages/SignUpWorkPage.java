...
public class SignUpWorkPage extends BasePageObject<ProfilePage> {
    ...
    private By emailField = By.xpath("//input[@class='mb1 pv2 lh-copy ph3 input-reset sans-serif black-80 ba bg-transparent" +
            " w-100 b--black-20']");
    private By passwordField = By.xpath("//input[@class='pv2 lh-copy ph3 input-reset sans-serif ba bg-transparent w-100 b--black" +
            "-20']");
